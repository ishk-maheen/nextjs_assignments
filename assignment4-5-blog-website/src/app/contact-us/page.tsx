                        ...
                        <div className="relative w-[280px] md:w-[500px] mx-auto formMainBody backdrop-filter backdrop-blur-lg p-6 md:p-8 rounded-lg shadow-lg space-y-6"><form className="space-y-4 md:space-y-6">
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex justify-center space-x-6 md:space-x-8 mt-4 md:mt-6">
                                    <a target="_blank" className="text-cyan-700 hover:text-cyan-800 transition duration-300 text-xl md:text-2xl" href="https://www.linkedin.com/in/ishkmaheen24/">
                                        <i className="fab fa-linkedin"></i>
                                    </a>
                                    <a target="_blank" className="text-cyan-400 hover:text-cyan-500 transition duration-300 text-xl md:text-2xl" href="https://github.com/ishk-maheen">
                                        <i className="fab fa-github"></i>
                                    </a>
                                </div>
                                <div className="mt-4">
                                    <div className="flex justify-center space-x-4"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ishkmaheen24/">
                                        <button className="px-5 py-2 md:px-6 md:py-3 text-sm md:text-base bg-sky-300 text-black rounded-lg font-bold hover:bg-sky-700 hover:text-white transition duration-300  hover:scale-110 transition duration-300">LinkedIn</button></a>
                                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/ishk-maheen">
                                            <button className="px-5 py-2 md:px-6 md:py-3 text-sm md:text-base bg-sky-300 text-black rounded-lg font-bold hover:bg-sky-700 hover:text-white transition duration-300 hover:scale-110 transition duration-300">GitHub</button></a>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-6 md:mt-8"><p className="text-md md:text-lg text-gray-300">Prefer direct email? Reach us at <a className="text-cyan-400 hover:text-cyan-500 transition duration-300" href="mailto:maheenrashidsheikh786@gmail.com">maheenrashidsheikh786@gmail.com</a>
                            </p>
                            </div>
                        </div>
                    </div>
